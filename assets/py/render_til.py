...
def generate_sidebar_list():
    ...
    for year_month in ALL_YEAR_MONTHS:
        year, month = year_month
        list_item_html = f"<li><a href=\"https://iamguanxili.github.io/til/{year}/{month}/index.html\">{MONTHS[month]} {year}</a></li>"
...
<div class="col-4 col-12-medium">
    <div id="sidebar">
        ...
        <!-- Sidebar -->
            <section>
                <a href=\"https://iamguanxili.github.io/til/index.html\">All Posts</a>
...
def generate_month_html(year_month):
    ...
    for day in range(1, 32):
        if (year, month, day) in ALL_YEAR_MONTH_DAYS:
            ...
            list_of_day_summaries_html.append(f"<a href=\"https://iamguanxili.github.io/til/{year}/{month}/{day}/index.html\"><h4>{MONTHS[month]} {day}, {year}</h4></a>\n <p>{day_summary} <em><a href=\"https://iamguanxili.github.io/til/{year}/{month}/{day}/index.html\">(continue reading)</a></em></p>\n")
...
def generate_home_html():
    ...
    for (year, month) in ALL_YEAR_MONTHS:
        ...
        with open(month_summary_path, "r") as file:
            month_summary = file.read()
        list_of_month_summaries_html.append(f"<a href=\"https://iamguanxili.github.io/til/{year}/{month}/index.html\"><h3>{MONTHS[month]} {year}</h3></a>\n <p>{month_summary}</p>")
